...
public class FieldConstants {
  ...
  public static final int aprilTagCount = AprilTagLayoutType.PRACTICE.getLayout().getTags().size();
  public static final double aprilTagWidth = Units.inchesToMeters(6.5);
  public static final AprilTagLayoutType defaultAprilTagType = AprilTagLayoutType.PRACTICE;

  // Field dimensions
  public static final double fieldLength = AprilTagLayoutType.PRACTICE.getLayout().getFieldLength();
  public static final double fieldWidth = AprilTagLayoutType.PRACTICE.getLayout().getFieldWidth();

  /**
   * PRACTICEly defined and relevant vertical lines found on the field (defined by X-axis offset)
   */
  public static class LinesVertical {
    public static final double center = fieldLength / 2.0;
    public static final double starting =
        AprilTagLayoutType.PRACTICE.getLayout().getTagPose(26).get().getX();
    public static final double allianceZone = starting;
    public static final double hubCenter =
        AprilTagLayoutType.PRACTICE.getLayout().getTagPose(26).get().getX() + Hub.width / 2.0;
    ...
    public static final double oppHubCenter =
        AprilTagLayoutType.PRACTICE.getLayout().getTagPose(4).get().getX() + Hub.width / 2.0;
    public static final double oppAllianceZone =
        AprilTagLayoutType.PRACTICE.getLayout().getTagPose(10).get().getX();
  }

  /**
   * PRACTICEly defined and relevant horizontal lines found on the field (defined by Y-axis offset)
   *
  ...
  public static class Hub {
    ...
    public static final Translation3d topCenterPoint =
        new Translation3d(
            AprilTagLayoutType.PRACTICE.getLayout().getTagPose(26).get().getX() + width / 2.0,
            fieldWidth / 2.0,
            height);
    ...
    public static final Translation3d oppTopCenterPoint =
        new Translation3d(
            AprilTagLayoutType.PRACTICE.getLayout().getTagPose(4).get().getX() + width / 2.0,
            fieldWidth / 2.0,
            height);
    ...
    public static final Pose2d nearFace =
        AprilTagLayoutType.PRACTICE.getLayout().getTagPose(26).get().toPose2d();
    public static final Pose2d farFace =
        AprilTagLayoutType.PRACTICE.getLayout().getTagPose(20).get().toPose2d();
    public static final Pose2d rightFace =
        AprilTagLayoutType.PRACTICE.getLayout().getTagPose(18).get().toPose2d();
    public static final Pose2d leftFace =
        AprilTagLayoutType.PRACTICE.getLayout().getTagPose(21).get().toPose2d();
  }
  ...
  public static class Tower {
    ...
    public static final Translation2d centerPoint =
        new Translation2d(
            frontFaceX, AprilTagLayoutType.PRACTICE.getLayout().getTagPose(31).get().getY());
    public static final Translation2d leftUpright =
        new Translation2d(
            frontFaceX,
            (AprilTagLayoutType.PRACTICE.getLayout().getTagPose(31).get().getY())
                + innerOpeningWidth / 2
    ...
    public static final Translation2d oppCenterPoint =
        new Translation2d(
            ...
            AprilTagLayoutType.PRACTICE.getLayout().getTagPose(15).get().getY());
  ...
  public static class Outpost {
    ...
    // Relevant reference points on alliance side
    public static final Translation2d centerPoint =
        new Translation2d(0, AprilTagLayoutType.PRACTICE.getLayout().getTagPose(29).get().getY());
  }
  ...
  public enum FieldType {
    ...
    private String getJsonFolder() {
      boolean check = fieldType == FieldType.ANDYMARK;
      if (check == true) {
        return "andymark";
      } else {
        return "welded";
